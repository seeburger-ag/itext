        ...
        try {
            ...
            if (basicResponse != null) {
                ...
                if (responses.length == 1) {
                	...
                	// TIBCO Software #6 : Part 3 - START
                    else if (status instanceof org.bouncycastle.cert.ocsp.RevokedStatus) {
                    // TIBCO Software #6 : Part 3 - END
