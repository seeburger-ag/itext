...
public class PdfPKCS7 {
    ...
    public PdfPKCS7(byte[] contentsKey, String provider) {
        try {
            ...
            //
            // TIBCO Software #6 : Part 5 - START
            ASN1Primitive pkcs;
            // TIBCO Software #6 : Part 5 - END
            ...
            if (signerInfo.getObjectAt(next) instanceof ASN1TaggedObject) {
                ...
                // TIBCO Software #6 : Part 6 - START
                sigAttr = sseq.getEncoded(ASN1Encoding.DER);
                // TIBCO Software #6 : Part 6 - END
...
*/    }
    ...
    public boolean isRevocationValid() {
        // TIBCO Software #6 : Part 11 - START
    	throw new UnsupportedOperationException();
/*        if (basicResp == null)
            return false;
        if (signCerts.size() < 2)
